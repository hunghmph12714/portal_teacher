...
class Classes extends Model
{
    ...
    protected $fillable = ['id','center_id','course_id','code','document','active','config','fee','open_date','name','note','student_number','adjust_fee','online_id','password','droped_number','waiting_number','transfer_number', 'type', 'year'];
    ...
    public function students(){
        return $this->belongsToMany('App\Student','student_class','class_id','student_id')
                    ...
                    ->withPivot('status', 'entrance_date','stats','drop_time','id as sc_id','transfer_date')
