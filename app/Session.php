...
class Session extends Model
{
    ...
    protected $fillable = ['id','class_id','teacher_id','center_id','room_id','document','exercice','from','to','date','ss_number','stats','exercice','status','note', 'fee','content','btvn_content','type','present_number','absent_number'];
