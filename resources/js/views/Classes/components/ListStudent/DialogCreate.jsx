    ...
    UNSAFE_componentWillReceiveProps(nextProps){
        ...
        if(nextProps.type == 'edit'){
            this.setState({
                ...
                transfer_date: (nextProps.student.drop_time) ? new Date(nextProps.student.drop_time) : null,
                new_active_date: (nextProps.student.transfer_date) ? new Date(nextProps.student.transfer_date) : null,
