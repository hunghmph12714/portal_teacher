    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="https://vietelite.edu.vn/wp-content/uploads/elementor/thumbs/logo-1-p7kfawkfsyjlo8t1heumzl3qiu0mhvx9tdy04iq5fk.png"  class="navbar-brand-img" alt="...">
        </a>
      </div>
   @if (Auth::user())  
    <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('teacher.class', ['id'=>Auth::user()->id]) }}" target="_blank">
