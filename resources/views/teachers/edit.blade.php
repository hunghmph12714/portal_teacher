              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="input-username" name="name" class="form-control" value="{{ $teacher->name}}"
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="email" id="input-email" class="form-control" name="email" value="{{ $teacher->email}}"
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="input-first-name" class="form-control" placeholder="Số điện thoại"
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="input-last-name" class="form-control" placeholder="Môn giảng dạy"
                      name="domain" value="{{ $teacher->domain}}">
                  </div>
                </div> @error('domain')
                <p class="text-danger">{{ $message }}</p>
                @enderror
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input id="input-address" name="address" class="form-control" placeholder="Home Address"
                      value="{{ $teacher->address}}" type="text">
                  </div>
                </div> @error('address')
                <p class="text-danger">{{ $message }}</p>
                @enderror
