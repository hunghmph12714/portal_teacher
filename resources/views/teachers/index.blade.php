        ...
        <tr>
            ...
            <td>
                <form action="/teacher" method="post" class="d-flex ">
                    @csrf
                    {{-- <select class="custom-select col-6" name="system_teacher" @if
                        (empty($teachers)&&$item->id==Auth::user()->id)
                        disabled
                        @endif id="">
                    ...
                    <select class="custom-select col-6" name="system_teacher" @if (empty($teacher)&&
            ...
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        ...
                        <a href="{{route('teacher.class', ['id' => $item->id])}}" class="dropdown-item"
                            class="dropdown-item">Lớp dạy</a>
